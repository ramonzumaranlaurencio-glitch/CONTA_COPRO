  ...
  return (
    <div className="h-screen flex flex-col bg-[#faf9f8] text-neutral-900">
      <header className="h-12 bg-[#0f172a] text-white flex items-center justify-between px-4">
        <div className="font-bold tracking-wide">CONTA_COLPRO Enterprise 🇨🇴</div>
        <input className="w-[420px] px-3 py-1 rounded text-black" placeholder="Buscar NIT, asiento, CUFE, hash DIAN..." />
        <div className="text-sm">Auditoría activa · DIAN Colombia</div>
      </header>
      <div className="flex flex-1 overflow-hidden">
        <aside className="w-60 bg-white border-r">
          {['Contabilidad', 'Facturación', 'DIAN', 'Bancos', 'Auditoría IA', 'Configuración'].map(x => (
