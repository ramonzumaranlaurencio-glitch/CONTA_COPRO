...
class Settings(BaseSettings):
    ...
    rag_corpus_sources: str = "ESTATUTO_TRIBUTARIO_CO,PUC_COLOMBIA,NORMATIVA_DIAN,NIIF_PYMES_CO,CST_COLOMBIA,LEY_100_1993"
    rag_embedding_dimensions: int = 768
    chroma_persist_directory: str = "./.chroma"
    chroma_collection_name: str = "contacolpro_legal_docs"
    dian_fe_endpoint: str | None = None
