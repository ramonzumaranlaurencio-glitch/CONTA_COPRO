...
class FinancialDocument(Base):
    ...
    detraccion_amount: Mapped[Decimal] = mapped_column(Numeric(18, 2), nullable=False, default=0)
    percepcion_amount: Mapped[Decimal] = mapped_column(Numeric(18, 2), nullable=False, default=0)
...
class TaxDetermination(Base):
    ...
    output_igv: Mapped[Decimal] = mapped_column(Numeric(18, 2), nullable=False, default=0)
    input_igv: Mapped[Decimal] = mapped_column(Numeric(18, 2), nullable=False, default=0)
    igv_payable: Mapped[Decimal] = mapped_column(Numeric(18, 2), nullable=False, default=0)
    detracciones: Mapped[Decimal] = mapped_column(Numeric(18, 2), nullable=False, default=0)
    percepciones: Mapped[Decimal] = mapped_column(Numeric(18, 2), nullable=False, default=0)
